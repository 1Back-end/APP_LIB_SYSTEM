...
class ConfigClass(BaseSettings):
    ...
    SQLALCHEMY_DATABASE_URL: str = get_secret("SQLALCHEMY_DATABASE_URL", 'postgresql://postgres:2002@localhost:5432/api_lib_system_db')
    ...
    PROJECT_NAME: str = get_secret("PROJECT_NAME", "API LIB SYSTEM")
