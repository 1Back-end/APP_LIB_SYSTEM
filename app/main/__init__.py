...
description = '''
    Cette API est conçue pour gérer une bibliothèque en ligne.
    Elle fournit des endpoints sécurisés pour l’enregistrement, l’emprunt, la restitution et la gestion des livres.
    La plupart des opérations nécessitent une authentification afin d’assurer la sécurité et une utilisation appropriée par les bibliothécaires et les lecteurs.
'''
